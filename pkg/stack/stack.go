...
var DHIS2Core = model.Stack{
	...
	Parameters: model.StackParameters{
		...
		"LIVENESS_PROBE_TIMEOUT_SECONDS":  {Priority: 9, DisplayName: "Liveness Probe Timeout Seconds", DefaultValue: &dhis2CoreDefaults.livenessProbeTimeoutSeconds},
		"READINESS_PROBE_TIMEOUT_SECONDS": {Priority: 10, DisplayName: "Readiness Probe Timeout Seconds", DefaultValue: &dhis2CoreDefaults.readinessProbeTimeoutSeconds},
		"STARTUP_PROBE_FAILURE_THRESHOLD": {Priority: 11, DisplayName: "Startup Probe Failure Threshold", DefaultValue: &dhis2CoreDefaults.startupProbeFailureThreshold},
		...
		"GOOGLE_AUTH_PROJECT_ID":          {Priority: 15, DisplayName: "Google auth project id", DefaultValue: &dhis2CoreDefaults.googleAuthClientId},
		"GOOGLE_AUTH_PRIVATE_KEY":         {Priority: 16, DisplayName: "Google auth private key", DefaultValue: &dhis2CoreDefaults.googleAuthPrivateKey},
		"GOOGLE_AUTH_PRIVATE_KEY_ID":      {Priority: 17, DisplayName: "Google auth private key id", DefaultValue: &dhis2CoreDefaults.googleAuthPrivateKeyId},
		"GOOGLE_AUTH_CLIENT_EMAIL":        {Priority: 18, DisplayName: "Google auth client email", DefaultValue: &dhis2CoreDefaults.googleAuthClientEmail},
		"GOOGLE_AUTH_CLIENT_ID":           {Priority: 19, DisplayName: "Google auth client id", DefaultValue: &dhis2CoreDefaults.googleAuthClientId},
...
var DHIS2 = model.Stack{
	...
	Parameters: model.StackParameters{
		...
		"LIVENESS_PROBE_TIMEOUT_SECONDS":  {Priority: 18, DisplayName: "Liveness Probe Timeout Seconds", DefaultValue: &dhis2CoreDefaults.livenessProbeTimeoutSeconds},
		"READINESS_PROBE_TIMEOUT_SECONDS": {Priority: 19, DisplayName: "Readiness Probe Timeout Seconds", DefaultValue: &dhis2CoreDefaults.readinessProbeTimeoutSeconds},
		"STARTUP_PROBE_FAILURE_THRESHOLD": {Priority: 20, DisplayName: "Startup Probe Failure Threshold", DefaultValue: &dhis2CoreDefaults.startupProbeFailureThreshold},
		...
		"CHART_VERSION":                   {Priority: 22, DisplayName: "Chart Version", DefaultValue: &dhis2CoreDefaults.chartVersion},
		"JAVA_OPTS":                       {Priority: 23, DisplayName: "JAVA Options", DefaultValue: &dhis2CoreDefaults.javaOpts},
		"GOOGLE_AUTH_PROJECT_ID":          {Priority: 24, DisplayName: "Google auth project id", DefaultValue: &dhis2CoreDefaults.googleAuthClientId},
		"GOOGLE_AUTH_PRIVATE_KEY":         {Priority: 25, DisplayName: "Google auth private key", DefaultValue: &dhis2CoreDefaults.googleAuthPrivateKey},
		"GOOGLE_AUTH_PRIVATE_KEY_ID":      {Priority: 26, DisplayName: "Google auth private key id", DefaultValue: &dhis2CoreDefaults.googleAuthPrivateKeyId},
		"GOOGLE_AUTH_CLIENT_EMAIL":        {Priority: 27, DisplayName: "Google auth client email", DefaultValue: &dhis2CoreDefaults.googleAuthClientEmail},
		"GOOGLE_AUTH_CLIENT_ID":           {Priority: 28, DisplayName: "Google auth client id", DefaultValue: &dhis2CoreDefaults.googleAuthClientId},
	},
	ParameterProviders: model.ParameterProviders{
		"DATABASE_HOSTNAME": postgresHostnameProvider,
	},
