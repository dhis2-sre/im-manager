...
// WithID adds the id to the delete instance params
func (o *DeleteInstanceParams) WithID(id uint64) *DeleteInstanceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete instance params
func (o *DeleteInstanceParams) SetID(id uint64) {
	o.ID = id
}
