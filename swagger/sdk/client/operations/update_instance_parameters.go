...
// WithID adds the id to the update instance params
func (o *UpdateInstanceParams) WithID(id uint64) *UpdateInstanceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update instance params
func (o *UpdateInstanceParams) SetID(id uint64) {
	o.ID = id
}
